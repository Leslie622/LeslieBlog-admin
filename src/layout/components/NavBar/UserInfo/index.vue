<template>
  <div class="user" @click="userInfoDrawer = true">
  ...
  <el-drawer v-model="userInfoDrawer" :close="(introduceEdit = false)" direction="rtl" :size="300" class="user-info-drawer">
    ...
    <div class="introduce__wrapper">
      ...
      <el-input v-model="userInfo.introduce" type="textarea" v-else @change="sumbitIntroduce" @blur="introduceEdit = false" ref="introInputRef" :rows="1"></el-input>
      <Icon icon="material-symbols:edit-square-outline" width="18px" class="introduce__edit" @click="editIntroduceHandler" v-if="introduceEdit === false"></Icon>
    </div>
